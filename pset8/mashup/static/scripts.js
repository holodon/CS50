...
function addMarker(place) {
    ...
    var image = "https://maps.google.com/mapfiles/kml/pal3/icon62.png";
    var latLng = {
        lat: place.latitude,
        lng: place.longitude
    };
    //    optionally if using only one (fts) table:
    ...
    marker.addListener("click", function() {
        // I like it with this more, but is not like the staff's
        ...
        $.getJSON(Flask.url_for("articles"), {
            ...
            .done(function(data, textStatus, jqXHR) {
                ...
                content = "<ul>";
                // i like this better but let's keep to the specs:
...
function showInfo(marker, content) {
    ...
    //    i like this better but let's keep to the specs
    //    div += "<div style = 'overflow: auto; overflow-x: hidden; height: 90px'>" + content + "</div>";
    //    (also check marker.addListener)
        div += content;
    }
